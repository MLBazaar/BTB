...
class TestBaseMetaModel(TestCase):
    ...
    def test__init_model__MODEL_KWARGS_none(self):
        # setup
        instance = MagicMock()
        instance._MODEL_KWARGS = None
        ...
        # assert
        assert instance._model == 'model_instance'
        instance._MODEL_CLASS.assert_called_once_with()

    def test__init_model__MODEL_KWARGS(self):
        # setup
        instance = MagicMock()
        instance._MODEL_KWARGS = {'a': 1}
        instance._MODEL_CLASS.return_value = 'model_instance'
    ...
    def test__fit(self):
        ...
        instance._model.fit.called_once_with('trials', 'scores')

    def test__predict(self):
        # setup
        instance = MagicMock()
        instance._model.predict.return_value = [1]
        ...
        instance._model.predict.assert_called_once_with('trials')
